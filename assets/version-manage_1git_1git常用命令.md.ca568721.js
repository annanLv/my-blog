import{_ as s,o as n,c as a,U as l}from"./chunks/framework.2f2c55cd.js";const m=JSON.parse('{"title":"git 常用命令","description":"","frontmatter":{},"headers":[],"relativePath":"version-manage/1git/1git常用命令.md","filePath":"version-manage/1git/1git常用命令.md"}'),p={name:"version-manage/1git/1git常用命令.md"},e=l(`<h1 id="git-常用命令" tabindex="-1"><a href="https://gitee.com/mao-118/utools-filebed/raw/master/git/Git-2.23.0-64-bit.exe" target="_blank" rel="noreferrer">git</a> 常用命令 <a class="header-anchor" href="#git-常用命令" aria-label="Permalink to &quot;[git](https://gitee.com/mao-118/utools-filebed/raw/master/git/Git-2.23.0-64-bit.exe) 常用命令&quot;">​</a></h1><h2 id="仓库" tabindex="-1">仓库 <a class="header-anchor" href="#仓库" aria-label="Permalink to &quot;仓库&quot;">​</a></h2><div class="language-bash line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;"># 在当前目录新建一个Git代码库</span></span>
...
<span class="line"><span style="color:#FFCB6B;">git</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">archive</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div>`,21),o=[e];function c(r,t,i,C,y,b){return n(),a("div",null,o)}const A=s(p,[["render",c]]);export{m as __pageData,A as default};
